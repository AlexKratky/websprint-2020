...
class AuthController
{
    ...
    public static function edit() {
        ...
        self::$handler::setParameters([
            ...
            'firstname'=>self::$auth->user('firstname'),
            'lastname'=>self::$auth->user('lastname'),
            'phone'=>self::$auth->user('phone'),
            'skill'=>self::$auth->user('skill'),
            'describe'=>self::$auth->user('describe'),
            'price'=>self::$auth->user('price'),
            'avatar'=>self::$auth->user('avatar'),
